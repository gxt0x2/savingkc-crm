-- Retire Manifest as a Pipeline read dependency.
--
-- V3 reads identity, contact, property, opportunity, conversation, task, and
-- activity state from first-class CRM tables/projections. Unreviewed Manifest
-- recommendations and tags are intentionally not migrated into operational
-- truth. Source-backed county segments remain in the Prospecting read model.

CREATE OR REPLACE FUNCTION public.contact_workspace_page_v3(
...
REVOKE ALL ON FUNCTION public.contact_workspace_page_v3(
  TEXT, TEXT, INTEGER, JSONB, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT,
  TEXT, TEXT, TEXT, TEXT, TEXT, TIMESTAMPTZ
) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.contact_workspace_page_v3(
  TEXT, TEXT, INTEGER, JSONB, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT,
  TEXT, TEXT, TEXT, TEXT, TEXT, TIMESTAMPTZ
) TO service_role;

COMMENT ON FUNCTION public.contact_workspace_page_v3(
  TEXT, TEXT, INTEGER, JSONB, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT,
  TEXT, TEXT, TEXT, TEXT, TEXT, TIMESTAMPTZ
) IS 'Returns the canonical, bounded Pipeline page without reading Manifest recommendations or tags; response rows remain capped at 50.';
