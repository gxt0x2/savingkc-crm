...
const files = [
  ...
  'src/components/leads/governed-next-action.tsx',
  'src/components/leads/lead-qualification-panel.tsx',
  'src/components/leads/email-thread.tsx',
  'src/components/leads/lead-opportunity-panel.tsx',
  'src/components/leads/lead-workspace.tsx',
  'src/components/leads/mail-tracker.tsx',
  'src/components/leads/entity-identity-status.tsx',
  'src/components/leads/property-details-card.tsx',
  'src/components/ai/lead-ai-change-review.tsx',
