...
const documentedServerCommands = [
  ...
  'THR-READ', 'THR-TAKEOVER', 'THR-TRANSFER', 'THR-RELEASE', 'THR-DRAFT', 'THR-NOTE', 'THR-SCHEDULE', 'THR-SEND', 'THR-REGENERATE', 'THR-SNOOZE', 'THR-CLOSE', 'THR-TAG', 'THR-LINK', 'THR-HANDOFF',
  'REV-APPROVE', 'REV-REJECT', 'REV-ASSIGN', 'REV-RESOLVE', 'INB-SAVEVIEW', 'INB-DELETEVIEW',
  'HAN-ACCEPT', 'HAN-RESOLVE', 'HAN-REASSIGN', 'HAN-SCHEDULE', 'HAN-OUTCOME', 'HAN-QUALIFY', 'HAN-RETURN',
