 ...
 * Casey's company number (+18167277667) -> Casey first, Ernest second.
 ...
 * Casey's company number -> Casey primary, everything else -> Ernest primary.
 */
export function getAgentRouting(calledNumber: string): AgentRouting {
  if (calledNumber === CASEY_COMPANY) {
