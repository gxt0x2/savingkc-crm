...
export function appointmentCopy(input: {
  ...
  const bodies: Record<string, string> = {
    booking_sms: `Hey ${name}, it's ${rep} with Saving KC Homebuyers. I have us locked in for ${apptDate} at ${time}. ${shortNotice ? 'Reply YES to confirm. ' : ''}${sameDay ? '' : "I'll text you the morning of too. "}My direct number is ${input.repPhone} if anything comes up before then.`,
