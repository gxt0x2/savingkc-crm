  ...
  return (
    <main className="mx-auto w-full max-w-[1720px] space-y-3 px-3 py-4 pb-24 sm:px-5 lg:px-6">
      <header className="crm-panel flex flex-col gap-4 rounded-2xl px-5 py-4 xl:flex-row xl:items-center xl:justify-between">
        <div><p className="crm-eyebrow">CEO Operating System · Continuous improvement</p><h1 className="mt-1 text-[25px] font-black tracking-[-0.035em]">Andon system</h1><p className="mt-0.5 max-w-3xl text-xs font-medium text-[var(--crm-text-muted)]">One live queue for process, system, data, and AI issues - from first signal through root cause and verified resolution.</p></div>
