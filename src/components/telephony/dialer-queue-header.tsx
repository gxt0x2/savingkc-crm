  ...
  return (
    <div className="border-b border-[#2B2B31] bg-[#17171D] px-5 py-3" style={{ borderLeft: '3px solid #E32E2E' }}>
      <div className="flex items-center justify-between gap-3">
        ...
        {workspace ? null : <button onClick={onEnd} className="flex-shrink-0 rounded-[8px] border border-[#31313A] px-2 py-1 text-[10px] font-bold uppercase tracking-wider text-white/50 transition-colors hover:border-white/40 hover:text-white" title="End heir queue — back to normal dialer">End</button>}
      </div>
