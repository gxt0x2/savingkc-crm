  ...
  async function completeReview(call: ReviewCall) {
    ...
    try {
      ...
      if (call.id === 'test-review-preview') {
        ...
        workflow = { ...call.reviewWorkflow, status: 'completed', score: liveScore, completedBy: viewerEmail, reviewNote: note, voiceoverPath: preservedVoiceover, voiceoverMimeType: voiceoverBlob?.type || null }
      } else {
