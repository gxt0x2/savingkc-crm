...
function testCall(viewerEmail: string, savedWorkflow?: Workflow | null): ReviewCall {
  ...
  const recoveredWorkflow: Workflow = { status: 'completed', framework: 'junior_acquisitions', score: 2, submittedBy: 'casey@savingkc.com', assignedReviewer: viewerEmail, completedBy: viewerEmail, reviewNote: 'Recovered completed test review.', answers: recoveredAnswers, tags: ['Needs Coaching', 'Motivation'], voiceoverPath: '/audio/ernest-voicemail.mp3', voiceoverMimeType: 'audio/mpeg' }
  return {
    ...
    reviewWorkflow: savedWorkflow ? { ...recoveredWorkflow, ...savedWorkflow, voiceoverPath: savedWorkflow.voiceoverPath || recoveredWorkflow.voiceoverPath, voiceoverMimeType: savedWorkflow.voiceoverMimeType || recoveredWorkflow.voiceoverMimeType } : recoveredWorkflow,
  }
}
