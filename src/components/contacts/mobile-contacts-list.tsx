...
export function MobileContactsList({ items, selectedIds, onToggle, onOpen, onCall, showScore = false }: { items: ContactWorkspaceRow[]; selectedIds: Set<string>; onToggle: (id: string) => void; onOpen: (id: string) => void; onCall: (row: ContactWorkspaceRow) => void; showScore?: boolean }) {
