...
export function WorkspaceFrame({
  ...
  return (
    <div className="crm-workspace-shell flex h-screen overflow-hidden bg-white text-[#132238]">
          ...
          <div className="ml-auto flex items-center gap-5">
            <div className="relative">
              <button type="button" onClick={() => setNotificationsOpen((value) => !value)} aria-expanded={notificationsOpen} className="relative text-[#132238]" aria-label="Notifications">
                ...
                <span className="absolute -right-2 -top-2 flex h-5 min-w-5 items-center justify-center rounded-full bg-[#df3038] px-1 text-[10px] font-bold text-white">{resolvedNeedsReply}</span>
              </button>
