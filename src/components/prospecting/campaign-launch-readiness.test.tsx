...
const campaign: ProspectingCampaignDetail = {
  ...
  steps: [{ id: 'step-1', position: 1, delayMinutes: 0, bodyTemplate: 'Hi {{first_name}}' }], members: [], stats: { total: 4, active: 3, suppressed: 1, replied: 0, completed: 0, sent: 0, delivered: 0, failed: 0 }, operations: { queued: 0, processing: 0, nextActionAt: null, lastSentAt: null },
}
