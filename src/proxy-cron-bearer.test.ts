...
describe('cron proxy bearer allowlist', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('does not grant bearer trust to a newly added cron route', async () => {
    const response = await proxy(bearerRequest('/api/cron/unreviewed'), event)
