...
describe('worker proxy bearer allowlist', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('does not grant bearer trust to a newly added worker route', async () => {
    const response = await proxy(bearerRequest('/api/workers/unreviewed'), event)
