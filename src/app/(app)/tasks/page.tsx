...
export default function TasksPage() {
  ...
  const laneCounts = data?.laneCounts ?? { current: 0, review: 0, quarantine: 0, all: 0 }
  ...
  const taskChangesEnabled = (task: Task) => task.operational_lane === 'current' || !task.operational_lane || reviewActionsEnabled
  ...
  const showReviewGate = lane !== 'current' || pageTasks.some((task) => task.operational_lane === 'review' || task.operational_lane === 'quarantine')
