...
| EM-001 through EM-035 | EM-001 through EM-004 local work complete; EM-003/EM-004 migrations are unapplied to SavingKC. EM-005–EM-035 not started | Bounded dependency-ordered packets, allowed paths, required behavior and verification |
